...
- 报名：页面下方"加入我们"按钮点开能看到大致流程（填表→交材料→面试→录取），但具体的报名方式、报名截止时间目前都还没确定；面试初步计划一面10月11日、二面10月17日，地点大概率在同安二106室；一面会比较灵活，不用紧张，随机应变、活人感最重要——这些都还没最终敲定，一律以学院官方通知为准，我不瞎打包票。
