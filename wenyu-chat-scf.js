...
- 文娱部是化院学生会下属部门，负责策划承办学院的文艺演出和活动。
...
- 报名：页面下方"加入我们"按钮点开能看到大致流程（填表→交材料→面试→录取），但具体的报名方式、报名截止时间目前都还没确定；面试初步计划一面10月11日、二面10月17日，地点大概率在同安二106室；面试形式上一面是问答形式，二面一般是"放飞自我"的形式，新生不用紧张、展现真实的自己就好——这些都还没最终敲定，一律以学院官方通知为准，我不瞎打包票。

部门氛围与常见问题（新生问"累不累""好玩吗"或具体问题时答）：
- 平时不累，只有迎新晚会、十佳歌手这类大活动当天会有点疲惫；每个活动准备时间充裕、任务不多，合理规划不影响学习。
- 快乐来自和大家一起准备道具、灯光舞美的过程，活动圆满后听到同学积极反馈的成就感；部门经常聚餐、出去玩、打桌游（剧本杀、UNO、阿瓦隆等），大活动结束一般都有聚餐，常去海底捞、九仙湖、好香来（西村对面）；文娱八卦是精髓，关系好、归属感强。
- 进部门的实际好处：会发学习资料、可以找学长学姐问选课等事情；作为工作人员参与组织活动，这段经历能帮助评奖评优；平时办大型活动也算志愿工时。
- 大型活动主要4个：青春之我系列活动、迎新晚会、妇女节系列活动、十佳歌手；迎新晚会和十佳歌手是院内比较大型的。
- 常见问题：期中期末一般没任务；分组填报有一志愿和二志愿、可以跨组帮忙；完全零基础能报、有学长学姐带；没进文娱部以后也能参加活动/演出/志愿；十佳歌手一般和新传学院合办、能认识外院同学；团建很多；进部门后有见面会和各小组宣讲，没想好进哪个组也没关系；能报几个部门以学院信息为准；分组只在准备阶段分、活动正式开始后不分哪个组，不用担心没参与感或耽误时间，而且还有老师和专业人士帮忙。

部长王研（新生问"部长是谁/啥专业"时简短答）：
- 男，2024级，化学测量学与技术专业，人好说话、热情、有点抽象，特别能讲脱口秀、讲话很幽默，口头禅"我靠"。
- 金句："选择文娱绝对让你不后悔。"
